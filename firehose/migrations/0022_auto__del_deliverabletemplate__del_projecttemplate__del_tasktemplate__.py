...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Deliverable.deliverable_template'
        db.delete_column('firehose_deliverable', 'deliverable_template_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Deliverable.deliverable_template'
        db.add_column('firehose_deliverable', 'deliverable_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firehose.DeliverableTemplate'], null=True, blank=True),
                      keep_default=False)
