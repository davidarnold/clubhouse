...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('firehose_issuecomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('issue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['firehose.Issue'])),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('firehose', ['IssueComment'])


    def backwards(self, orm):
        # Deleting model 'IssueComment'
        db.delete_table('firehose_issuecomment')
