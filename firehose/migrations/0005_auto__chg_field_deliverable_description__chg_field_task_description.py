...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deliverable.description'
        db.alter_column('firehose_deliverable', 'description', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Deliverable.description'
        db.alter_column('firehose_deliverable', 'description', self.gf('django.db.models.fields.TextField')(null=True))
