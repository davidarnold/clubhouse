...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Worker.dummy'
        db.delete_column('firehose_worker', 'dummy')

        # Adding field 'Worker.user'
        db.add_column('firehose_worker', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Worker.dummy'
        db.add_column('firehose_worker', 'dummy',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Worker.user'
        db.delete_column('firehose_worker', 'user_id')
