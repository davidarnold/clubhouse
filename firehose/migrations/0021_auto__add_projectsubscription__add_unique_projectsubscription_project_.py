...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectSubscription'
        db.create_table('firehose_projectsubscription', (
        ...
        db.send_create_signal('firehose', ['ProjectSubscription'])

        # Adding unique constraint on 'ProjectSubscription', fields ['project', 'subscriber']
        db.create_unique('firehose_projectsubscription', ['project_id', 'subscriber_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProjectSubscription', fields ['project', 'subscriber']
        db.delete_unique('firehose_projectsubscription', ['project_id', 'subscriber_id'])

        # Deleting model 'ProjectSubscription'
        db.delete_table('firehose_projectsubscription')
    ...
    models = {
        ...
        'firehose.issue': {
            ...
            'assignee': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assigned_issue'", 'null': 'True', 'to': "orm['auth.User']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'firehose.issuecomment': {
            'Meta': {'object_name': 'IssueComment'},
            'body': ('django.db.models.fields.TextField', [], {}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['firehose.Issue']"}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'firehose.project': {
        ...
        'firehose.projectsubscription': {
            'Meta': {'unique_together': "(('project', 'subscriber'),)", 'object_name': 'ProjectSubscription'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['firehose.Project']"}),
        ...
        'firehose.task': {
            ...
            'estimated_hours': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
