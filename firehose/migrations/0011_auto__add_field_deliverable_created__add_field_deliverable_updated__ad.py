...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deliverable.created'
        db.add_column('firehose_deliverable', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Deliverable.updated'
        db.add_column('firehose_deliverable', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 11, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Blocker.created'
        db.add_column('firehose_blocker', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Blocker.updated'
        db.add_column('firehose_blocker', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 11, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Task.created'
        db.add_column('firehose_task', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Task.updated'
        db.add_column('firehose_task', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 11, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Assignment.created'
        db.add_column('firehose_assignment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 1, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Assignment.updated'
        db.add_column('firehose_assignment', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 11, 1, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deliverable.created'
        db.delete_column('firehose_deliverable', 'created')

        # Deleting field 'Deliverable.updated'
        db.delete_column('firehose_deliverable', 'updated')

        # Deleting field 'Blocker.created'
        db.delete_column('firehose_blocker', 'created')

        # Deleting field 'Blocker.updated'
        db.delete_column('firehose_blocker', 'updated')

        # Deleting field 'Task.created'
        db.delete_column('firehose_task', 'created')

        # Deleting field 'Task.updated'
        db.delete_column('firehose_task', 'updated')

        # Deleting field 'Assignment.created'
        db.delete_column('firehose_assignment', 'created')

        # Deleting field 'Assignment.updated'
        db.delete_column('firehose_assignment', 'updated')
