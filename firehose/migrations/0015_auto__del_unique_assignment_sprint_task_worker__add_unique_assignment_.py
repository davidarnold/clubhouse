...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Assignment', fields ['sprint', 'task', 'worker']
        db.delete_unique('firehose_assignment', ['sprint_id', 'task_id', 'worker_id'])

        # Adding unique constraint on 'Assignment', fields ['sprint', 'task']
        db.create_unique('firehose_assignment', ['sprint_id', 'task_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Assignment', fields ['sprint', 'task']
        db.delete_unique('firehose_assignment', ['sprint_id', 'task_id'])

        # Adding unique constraint on 'Assignment', fields ['sprint', 'task', 'worker']
        db.create_unique('firehose_assignment', ['sprint_id', 'task_id', 'worker_id'])
