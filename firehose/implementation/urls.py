...
urlpatterns = patterns('',
    ...
    url(r'^project/(\d+)/beta/$', firehose.implementation.views.project, name='implementation-project'),
    url(r'^project/(\d+)/deliverable/(\d+)/$', firehose.implementation.views.project_deliverable, name='implementation-project-deliverable'),
