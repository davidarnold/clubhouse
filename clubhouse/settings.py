...
DATABASES = {
    'default': {
        ...
        'NAME':     os.environ.get('RDS_DB_NAME', 'clubhouse'),
...
# Email configuration
DEFAULT_FROM_EMAIL = 'Clubhouse Projects <no-reply@clubhouseprojects.com>'
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = os.environ.get('SES_HOSTNAME', 'localhost')
EMAIL_PORT = int(os.environ.get('SES_PORT', '1025'))
EMAIL_HOST_USER = os.environ.get('SES_USERNAME', '')
EMAIL_HOST_PASSWORD = os.environ.get('SES_PASSWORD', '')
EMAIL_USE_TLS = os.environ.get('SES_USE_TLS', '0') == '1'
...
# Adds "groups" context variable for simple group membership testing
from django.conf import global_settings
TEMPLATE_CONTEXT_PROCESSORS = global_settings.TEMPLATE_CONTEXT_PROCESSORS + (
    'firehose.context_processors.groups',
)
